...
##################################################
lapply(1:30, function(x) {p.adjust(rs_train_test_abcd[[x]]$abcd.train.perm[i], "fdr")})
lapply(1:30, function(x) {p.adjust(rs_train_test_abcd[[x]]$abcd.test.perm[i], "fdr")})
lapply(1:30, function(x) {p.adjust(rs_train_test_abcd[[x]]$genr.perm[i], "fdr")})
